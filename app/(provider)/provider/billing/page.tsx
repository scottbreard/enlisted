...
const TIERS = [
  {
    ...
    features: [
      ...
      'Company logo',
      '200-word company bio',
      'Up to 3 service categories',
      '1 exchange listing',
      'Standard placement (alphabetical within category)',
      'Email alert when an exec views your profile',
      'RFQ access — 24 hours after Featured Partners',
  ...
  },
  {
    ...
    features: [
      ...
      'Top placement — rotated among Featured Partners',
      '"Featured" badge on profile + listings',
      'Homepage rotation module',
      '1,000-word bio, unlimited categories, all exchanges',
      'Team page (up to 10 members with photos & bios)',
      'Up to 5 published case studies',
      '1 professionally produced 60–90s video/year',
      'Unlimited YouTube embeds + photo gallery',
      'Unlimited RFQs with 24h priority window',
      'Direct messaging from executives',
      'Full analytics dashboard',
      'Quarterly "Featured Expert" blog post on Enlisted',
      'Compliance Calendar sponsorship slot (quarterly)',
      'Annual webinar + podcast guest spot',
      'Annual industry report co-author credit',
