          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-28 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white mb-8 leading-relaxed max-w-xl anim-fade-up anim-d-2">
                The independent directory of professional service providers for TSX, TSXV, CSE, and Cboe Canada executives. Compare IR firms, lawyers, auditors, market makers, and 90+ categories — then manage everything in one place. Free for executives.
              </p>
        ...
        <section className="py-6 px-6 bg-white border-b" style={{ borderColor: 'var(--color-border)' }}>
          <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-sm font-semibold" style={{ color: 'var(--color-gray)' }}>
            {[
              ...
              'Free for executives.',
              'Built for TSX · TSXV · CSE · Cboe Canada',
            ].map((item, i) => (
